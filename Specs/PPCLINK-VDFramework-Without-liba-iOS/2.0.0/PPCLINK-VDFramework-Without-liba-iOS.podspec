Pod::Spec.new do |spec|
  spec.name         = 'PPCLINK-VDFramework-Without-liba-iOS'
  spec.version      = '2.0.0'
  ...
  spec.xcconfig = { "LIBRARY_SEARCH_PATHS" => "\"$(PODS_ROOT)/PPCLINK-VDFramework-Without-liba-iOS/**\"",
        "HEADER_SEARCH_PATHS" => "\"$(PODS_ROOT)/PPCLINK-VDFramework-Without-liba-iOS/**\"",  "FRAMEWORK_SEARCH_PATHS" => "\"$(PODS_ROOT)/PPCLINK-VDFramework-Without-liba-iOS/**\""}
end