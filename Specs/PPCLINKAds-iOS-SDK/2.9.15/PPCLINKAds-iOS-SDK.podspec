...
spec.summary      = 'PPCLINKAds-iOS-SDK (2017.06.21: Add max time show interstitial ad per session;  Fix bug not show admob ad on iPad; Support fullscreen ad on iPhone4s, check PT_PAID: stop init/request ad,  getNativeAdInfoToShow: support PPCLINK Native Ad, cache old fb native ad, fix bugs (support Vungle, show Interstitial ad:Support callback code block, Support Adcolony 3.x, update setProductType)'
